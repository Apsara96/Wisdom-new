                        ...
                        <Collapse isOpen={isOpen} navbar id="header1">
                            <Nav navbar className="ml-auto mt-2 mt-lg-0">
                                ...
                                <UncontrolledDropdown nav inNavbar>
                                    <DropdownToggle nav>
                                        Classes <i className="fa fa-angle-down m-l-5"></i>
                                    </DropdownToggle>
                                    <DropdownMenu className="b-none animated fadeInUp">
                                        <DropdownItem>Grade 1-4</DropdownItem>
                                        <DropdownItem>Scholarship</DropdownItem>
                                        <DropdownItem>Grade 6-9</DropdownItem>
                                        <DropdownItem divider />
                                        <DropdownItem>Ordinary Level</DropdownItem>
                                        <DropdownItem>Advanced Level</DropdownItem>
                                        <DropdownItem divider />
                                        <DropdownItem>Languages</DropdownItem>
                                    </DropdownMenu>
                                </UncontrolledDropdown>
                                {/* <NavItem><NavLink href="#">Freebies</NavLink></NavItem> */}
                                <NavItem><a className="btn btn-outline-success" href="#">Contact Us</a></NavItem>
                            </Nav>
                        </Collapse>
                    </Navbar>
                </Container>
